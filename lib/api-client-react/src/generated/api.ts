 ...
 */
export const getGetBusinessUrl = (ubid: string) => {
  return `/api/businesses/${ubid}`;
};
...
export const getBusiness = async (
  ...
  return customFetch<Business>(getGetBusinessUrl(ubid), {
    ...options,
    method: "GET",
  });
};

export const getGetBusinessQueryKey = (ubid: string) => {
  return [`/api/businesses/${ubid}`] as const;
};
...
>(
  ...
  const queryKey = queryOptions?.queryKey ?? getGetBusinessQueryKey(ubid);

  const queryFn: QueryFunction<Awaited<ReturnType<typeof getBusiness>>> = ({
    signal,
  }) => getBusiness(ubid, { signal, ...requestOptions });
...
>(
  ...
  const queryOptions = getGetBusinessQueryOptions(ubid, options);
...
export const listAlerts = async (
  ...
  return customFetch<IntelligenceAlert[]>(getListAlertsUrl(), {
    ...options,
    method: "GET",
  });
};
 ...
 */
export const getResolveEntitiesUrl = () => {
  return `/api/resolve`;
};
...
export const resolveEntities = async (
  ...
  return customFetch<ResolveResponse>(getResolveEntitiesUrl(), {
    ...options,
    method: "POST",
...
export const getResolveEntitiesMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  ...
  TContext
> => {
  const mutationKey = ["resolveEntities"];
  ...
  > = (props) => {
    ...
    return resolveEntities(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type ResolveEntitiesMutationResult = NonNullable<
  Awaited<ReturnType<typeof resolveEntities>>
>;
export type ResolveEntitiesMutationBody = BodyType<ResolveRequest>;
export type ResolveEntitiesMutationError = ErrorType<unknown>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getResolveEntitiesMutationOptions(options));
};
 ...
 */
export const getGetSectorAnalyticsUrl = () => {
  return `/api/sector-analytics`;
};

export const getSectorAnalytics = async (
  options?: RequestInit,
): Promise<SectorAnalytic[]> => {
  return customFetch<SectorAnalytic[]>(getGetSectorAnalyticsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetSectorAnalyticsQueryKey = () => {
  return [`/api/sector-analytics`] as const;
};

export const getGetSectorAnalyticsQueryOptions = <
  TData = Awaited<ReturnType<typeof getSectorAnalytics>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getSectorAnalytics>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetSectorAnalyticsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getSectorAnalytics>>
  > = ({ signal }) => getSectorAnalytics({ signal, ...requestOptions });
...
export type GetSectorAnalyticsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getSectorAnalytics>>
>;
export type GetSectorAnalyticsQueryError = ErrorType<unknown>;

/**
 * @summary Get sector compliance analytics
 */

export function useGetSectorAnalytics<
  TData = Awaited<ReturnType<typeof getSectorAnalytics>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetSectorAnalyticsQueryOptions(options);
